...
const Banner = () => {
  ...
  <div className="carousel flex transition-transform duration-500 ease-in-out cursor-pointer " ref={carouselRef}>
    <img src="./images/landscape5.jpg" alt="Image 1" className="w-full h-full object-cover opacity-65" />
    <img src="./images/view2.jpg" alt="Image 2" className="w-full h-full object-cover opacity-75" />
    
    <img src="./images/view5.jpg" alt="Image 4" className="w-full h-full object-cover opacity-75" />
    <img src="./images/landscape6.jpg" alt="Image 4" className="w-full h-full object-cover opacity-75" />
  </div>
</div>
