    ...
    <div className="p-4 bg-white">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {destinations.map((destination, index) => (
          <div key={index} className="flex items-center bg-green-600 rounded-l-full overflow-hidden shadow-lg transform transition duration-500 hover:scale-105 w-1/3 p-4">
